  ...
  return (
    <section className="py-24 container mx-auto relative">
      <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto flex flex-col gap-8">
        <div className="text-center text-black text-3xl font-bold font-manrope leading-normal">
          Order Confirmation
        </div>
          ...
          {orderItems.map((item) => (
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
                <div className="min-w-[120px] truncate h-[120px] bg-gray-50 rounded-xl flex items-center justify-center">
                  <img
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-2 w-full">
                <div className="w-7 flex items-center mx-auto justify-center h-7 text-center border border-gray-200 rounded-full">
                  {item.qty}
                </div>
                <h5 className="text-left text-black text-lg font-medium px-10">
        ...
        <div className="w-full p-5 rounded-xl border border-gray-200 flex flex-col gap-4">
          <div className="flex justify-between">
            <h5 className="text-gray-600 text-lg font-normal">Subtotal:</h5>
            <h5 className="text-gray-900 text-lg font-semibold">${total}</h5>
          </div>
          <div className="flex justify-between">
